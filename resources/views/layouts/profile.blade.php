    ...
    <div class="content">
        <div class="content__cover">
            <div class="content__avatar">
                <img src="{{url('/uploads/user/'.$user->image)}}" alt="" style="border-radius: 50%;">
            </div>
            <div class="content__bull"><span></span><span></span><span></span><span></span><span></span>
            </div>
        </div>
        <div class="content__actions">
            <a href="{{route('user.changePassword' , ['id'=>$user->id])}}">
            ...
            <a href="{{route('user.changeInfo' , ['id'=>$user->id])}}">
                ...
                </svg><span>Change Profile Info</span></a>
        </div>
        @yield('content')
    </div>
    <div class="bg">
